...
::: warning
As of the version 4.0 (RC 2), there are some limitations: you can only specify the time of departure, and you can only search for the train of the day.
:::
...
::: warning
As of the version 4.0 (RC 2), only subway lines and underground stations are supported for displaying station exit information.
:::
